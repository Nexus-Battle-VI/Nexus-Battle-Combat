...
Código de `Nexus-Battle-Combat`. Nexus Battles VI es un producto académico en desarrollo.
...
- El servidor es la autoridad: el cliente envía comandos, nunca estado ni resultados.
- La semilla y el estado del generador no se exponen mientras la batalla o simulación siga abierta.
- El JWT nunca viaja en la URL del WebSocket (ADR-020).
