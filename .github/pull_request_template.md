...
Título del Pull Request (convención obligatoria):
  feat(combat): [HU-NN] descripcion en infinitivo
  fix(combat): [BUG-NN] descripcion en infinitivo
...
- [ ] Pruebas contra MongoDB real (`npm run test:db`)
