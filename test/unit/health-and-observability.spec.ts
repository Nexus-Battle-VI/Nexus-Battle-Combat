...
describe('Sondas de salud', () => {
  ...
  it('version expone solo servicio, version y entorno', () => {
    expect(
      buildVersion({ service: 'nexus-battle-combat', version: '0.1.0', nodeEnv: 'test' }),
    ).toEqual({ service: 'nexus-battle-combat', version: '0.1.0', nodeEnv: 'test' })
  })
})
